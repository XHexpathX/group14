...
if ($_SERVER["REQUEST_METHOD"] == "GET") {
  ...
  $error = "";
    ...
    $conn = db_connect();
    $sql = "SELECT users.user_id, users.password, users.user_type, users.email_address, users.enrol_date, users.last_access
            FROM users
    ...
    if($records === 1) {
      ...
      $output = "Error! User " . $userID . " and the associated password does not exist." . $sql . $result;
      $password = "";
    }
  }
}
